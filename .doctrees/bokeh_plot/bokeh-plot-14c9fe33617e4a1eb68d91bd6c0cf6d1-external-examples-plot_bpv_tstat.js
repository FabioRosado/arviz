(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("ac412ffa-538c-4163-89c8-a07803c95b44");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ac412ffa-538c-4163-89c8-a07803c95b44' but no matching script tag was found.")
        }
